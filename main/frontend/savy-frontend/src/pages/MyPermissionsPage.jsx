...
const MyPermissionsPage = () => {
  ...
  return (
    <div className="ml-[260px] p-8 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-3">My Permissions</h1>
        <p className="text-gray-600">Manage access permissions to your health data and view expiry details</p>
      </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Scope</th>
